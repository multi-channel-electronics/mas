...
/****************************************************************************/
{
	...
	//printf(">> jam_process_wait_microseconds(): I guess we're waiting..\n");
...
/****************************************************************************/
{
	...
	//printf(">> jam_process_wait(): I guess we're waiting..\n");
...
//	printf(">> jam_execute_statement(): start time = %02u:%02u:%02u\n", time_delta/3600, (time_delta%3600)/60, time_delta%60);
