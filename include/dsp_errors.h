...
#define DSP_ERR_COMMAND         DSP_ERR_BASE + 0x0010
#define DSP_ERR_ERRORS          DSP_ERR_BASE + 0x0012
#define DSP_ERR_SYSTEM          DSP_ERR_BASE + 0x0013
#define DSP_ERR_IO              DSP_ERR_BASE + 0x0014
#define DSP_ERR_FLAGS           DSP_ERR_BASE + 0x0015
