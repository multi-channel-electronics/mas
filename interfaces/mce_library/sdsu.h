...
extern int mcedata_sdsu_ioctl(mce_context_t, unsigned long int, ...);
extern ssize_t mcedata_sdsu_read(mce_context_t, void*, size_t);
extern ssize_t mcedata_sdsu_write(mce_context_t, const void*, size_t);
