...
static int get_string(char *dest, const config_setting_t *parent,
        const char *name);

static int get_int(int *dest, const config_setting_t *parent,
        const char *name);

#if 0
static int get_int_elem(int *dest, const config_setting_t *parent,
        const char *name, int index);
#endif

static int get_int_array(int *dest, const config_setting_t *parent,
        const char *name, int max);

static int get_string_elem(char *dest, const config_setting_t *parent,
        const char *name, int index);

static int count_elem(const config_setting_t *parent, const char *name);
...
static int st_get_id(const string_table_t *st, const char *name, int *id);

static int st_index(const string_table_t *st, const char *name);
